...
if type=="draw"
{
	...
	var col=draw_get_colour(), newcol=ATEX_get_prop(props, "c", global.ATEX_settings[? "shadow-color"]), dx=ATEX_get_prop(props, "x", global.ATEX_settings[? "shadow-x"]), dy=ATEX_get_prop(props, "y", global.ATEX_settings[? "shadow-y"]);
...
if type=="init"
{
	global.ATEX_settings[? "shadow-x"]=1
	global.ATEX_settings[? "shadow-y"]=1
	global.ATEX_settings[? "shadow-color"]=c_black
	/*
